...
{
  [self requestSpecificAuthorization:locationPermission];
...
- (void) requestSpecificAuthorization:(RCTLocationPermissionCode)locationPermission
{
  if (!_locationManager) {
